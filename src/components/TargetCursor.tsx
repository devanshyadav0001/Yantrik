...
const getContainingBlock = (element: any) => {
...
const getContainingBlockOffset = (block: any) => {
...
const TargetCursor = ({
  ...
  hoverDuration = 0.2,
  parallaxOn = true,
  cursorColor = '#dc2626', // Use the Yantrik Red
  ...
  const containingBlockRef = useRef<any>(null);
  ...
  useEffect(() => {
    ...
    const enterHandler = (e: any) => {
      ...
      activeTarget = target;
      const corners = Array.from(cornersRef.current);
      corners.forEach((corner: any) => gsap.killTweensOf(corner, 'x,y'));
